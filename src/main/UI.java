...
//			g2.drawString(text, x, y);
		...
		// Help
			...
			try {
				...
				if (wikiNum == 0) {
					...
					g2.drawString("HP                   : " + Player.DefaultHealth, gp.tileSize * 17,
							gp.tileSize * 11);
					g2.drawString("Bullet Damage  : " + Player.DefaultBulletDamage, gp.tileSize * 17,
							gp.tileSize * 12);
					g2.drawString("Attack Speed    : " + Player.DefaultAttackSpeed, gp.tileSize * 17, gp.tileSize * 13);
					g2.drawString("Speed    : " + Player.DefaultSpeed, gp.tileSize * 17, gp.tileSize * 13);
				}
				if (wikiNum == 1) {
					...
					g2.drawString("HP                   : " + MonBat.DefaultHealth, gp.tileSize * 17, gp.tileSize * 11);
					g2.drawString("Body Damage   : " + MonBat.DefaultBodyDamage, gp.tileSize * 17, gp.tileSize * 12);
					g2.drawString("Speed  : " + MonFireBat.DefaultSpeed, gp.tileSize * 17, gp.tileSize * 14);
				}
				if (wikiNum == 2) {
					g2.drawImage(fireBat, gp.tileSize * 6 - 15, gp.tileSize * 11, gp.tileSize * 2, gp.tileSize * 2,
							null);
					...
					g2.drawString("HP                   : " + MonFireBat.DefaultHealth, gp.tileSize * 17,
							gp.tileSize * 11);
					g2.drawString("Body Damage   : " + MonFireBat.DefaultBodyDamage, gp.tileSize * 17,
							gp.tileSize * 12);
					g2.drawString("Bullet Damage  : " + MonFireBat.DefaultBulletDamage, gp.tileSize * 17,
							gp.tileSize * 13);
					g2.drawString("Speed  : " + MonFireBat.DefaultSpeed, gp.tileSize * 17, gp.tileSize * 14);
				}
				if (wikiNum == 3) {
					g2.drawImage(iceBat, gp.tileSize * 6 - 15, gp.tileSize * 11, gp.tileSize * 2, gp.tileSize * 2,
							null);
				...
				if (wikiNum == 4) {
					g2.drawImage(mush, gp.tileSize * 5 + 10, gp.tileSize * 11 - 20, gp.tileSize * 3, gp.tileSize * 3,
							null);
					...
					g2.drawString("Body Damage   : " + MonFireBat.DefaultBodyDamage, gp.tileSize * 17,
							gp.tileSize * 12);
					g2.drawString("Speed  : " + MonFireBat.DefaultSpeed, gp.tileSize * 17, gp.tileSize * 13);
				}
				if (wikiNum == 5) {
					g2.drawImage(lilMush, gp.tileSize * 6 - 20, gp.tileSize * 11, gp.tileSize * 2 + 20,
							gp.tileSize * 2 + 20, null);
				...
				if (wikiNum == 6) {
					g2.drawImage(chargeMush, gp.tileSize * 5 + 20, gp.tileSize * 11 - 20, gp.tileSize * 3,
							gp.tileSize * 3, null);
	...
	public void drawPauseScreen() {
		...
		if (pauseSubState == 1) {
			...
			try {
				BufferedImage health = ImageIO.read(getClass().getResourceAsStream("/powerup/health.png"));
				BufferedImage attack = ImageIO.read(getClass().getResourceAsStream("/powerup/attack.png"));
				BufferedImage attSpeed = ImageIO.read(getClass().getResourceAsStream("/powerup/attspeed.png"));
				BufferedImage movSpeed = ImageIO.read(getClass().getResourceAsStream("/powerup/speed.png"));
