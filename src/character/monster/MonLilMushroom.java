		...
		for (Bullet bullet : bullets) {
			...
			if(this.worldY == gp.player.worldY){
				if(this.worldX < gp.player.worldX) {
					g2.drawImage(bullet_left, bullet.worldX+gp.tileSize, bullet.worldY+gp.tileSize*5, 20, 20, null);
				}
				
				if(this.worldX > gp.player.worldX) {
					g2.drawImage(bullet_right, bullet.worldX+gp.tileSize, bullet.worldY+gp.tileSize*5, 20, 20, null);
				}
